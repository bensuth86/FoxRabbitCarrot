...
class Population():
        ...
        def reproduce(self,species):
                ...
                for i in range(0,births_pending):
                        ...
                        offspring = type(species)()  # create new instance depending on mother's class type i.e. for or rabbit
...
#       3) TO DO Create addtional foxes at fox location depending on rabbits consumed
#       4) TO DO Increment fox age and delete fox if lifespan exceeded
...
#------------------------Rabbits setup-------------------------------------#
rbbt_population = Population(600,Rabbit)

#------------------------Foxes setup---------------------------------------#
fox_population = Population(5,Fox)
